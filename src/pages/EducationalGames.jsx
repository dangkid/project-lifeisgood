        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center gap-4">
              <Link
                to="/panel-educativo"
                className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50"
              >
                Panel
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sm:p-8 transition-colors">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Tus Logros</h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              ...
              <div className="text-gray-700 dark:text-gray-300 font-medium">Juegos Jugados</div>
            </div>
            <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
              <div className="text-3xl font-bold text-green-700 dark:text-green-400 mb-2">
                {loading ? '...' : userStats?.totalPoints || 0}
              </div>
              <div className="text-gray-700 dark:text-gray-300 font-medium">Puntos Totales</div>
            </div>
            <div className="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
              ...
              <div className="text-gray-700 dark:text-gray-300 font-medium">Logros Desbloqueados</div>
            </div>
          </div>
          ...
          {userStats?.gameDetails && Object.keys(userStats.gameDetails).length > 0 && (
            <div className="mt-8 pt-8 border-t-2 border-gray-200 dark:border-gray-700">
              <h4 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6">Estadísticas por Juego</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {Object.entries(userStats.gameDetails).map(([gameId, stats]) => {
                  ...
                  return (
                    <div key={gameId} className="p-4 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600 transition-colors">
                      <h5 className="font-bold text-gray-900 dark:text-gray-100 mb-2">{gameNames[gameId]}</h5>
